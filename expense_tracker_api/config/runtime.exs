...
#
#     PHX_SERVER=true bin/expense_tracker_api start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :expense_tracker_api, ExpenseTrackerApiWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :expense_tracker_api, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :expense_tracker_api, ExpenseTrackerApi.Mailer,

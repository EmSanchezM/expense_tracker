...
config :expense_tracker_api, ExpenseTrackerApiWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: System.get_env("SECRET_KEY_BASE") || "y87Z8iAXqJWQZmpETIDlZwyKsCWxvYJLpsl2Caib8wkwRLaAIETZ3orCApNpjVy9",
  watchers: []
...
config :expense_tracker_api, dev_routes: true
